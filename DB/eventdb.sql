...
START TRANSACTION;
USE `eventdb`;
INSERT INTO `Event` (`id`, `name`, `location`, `description`, `date`) VALUES (1, 'Commercial Crew Boeing Orbital Flight Test (Uncrewed)', 'Cape Canaveral', 'Boeing\'s CST-100 Starliner will launch atop a United Launch Alliance Atlas V rocket from Space Launch Complex 41 at Cape Canaveral Air Force Station in Florida. This is the first of two demonstration flights required to prove the space systems meet NASA’s requirements for certification to carry astronauts to and from the International Space Station.', 'December 17, 2019');
INSERT INTO `Event` (`id`, `name`, `location`, `description`, `date`) VALUES (2, 'SpaceX Falcon 9SpaceX Falcon 9', 'Cape Canaveral', 'A SpaceX Falcon 9 rocket will launch the JCSAT 18/Kacific 1 communications satellite jointly owned by SKY Perfect JSAT Corp. of Japan and Kacific Broadband Satellites of Singapore. Built by Boeing, the JCSAT 18/Kacific 1 communications satellite will provide mobile and broadband services across the Asia-Pacific region.', 'December 15, 2019');
INSERT INTO `Event` (`id`, `name`, `location`, `description`, `date`) VALUES (3, 'Progress 74 Launch', 'Baikonur Cosmodrome', 'The uncrewed Russian Progress 74 cargo craft will launch to the International Space Station from the Baikonur Cosmodrome in Kazakhstan, delivering food, fuel and supplies.', 'December 6, 2019');
INSERT INTO `Event` (`id`, `name`, `location`, `description`, `date`) VALUES (4, 'SpaceX CRS-19', 'Cape Canaveral', 'An uncrewed SpaceX Dragon cargo spacecraft will lift off on a Falcon 9 rocket from Launch Complex 40 at Cape Canaveral Air Force Station in Florida, delivering supplies and equipment to the International Space Station.', 'December 4, 2019');
INSERT INTO `Event` (`id`, `name`, `location`, `description`, `date`) VALUES (DEFAULT, NULL, NULL, NULL, NULL);
